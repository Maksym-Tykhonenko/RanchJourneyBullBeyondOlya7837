...
import {AnimalDetailsPanel} from '../panels/AnimalDetailsPanel';
import {MyAnimalFormPanel} from '../panels/MyAnimalFormPanel';
import {QuizIntroPanel} from '../panels/QuizIntroPanel';
import {QuizPlayPanel} from '../panels/QuizPlayPanel';
import {QuizResultsPanel} from '../panels/QuizResultsPanel';
import {RanchSprintPlayPanel} from '../panels/RanchSprintPlayPanel';
import {HubTabs} from './HubTabs';
import {RootStackParams} from './RouteTypes';
import {palette} from '../core/palette';
import ProductScreen from '../panels/ProductScreen';
...
useEffect(() => {
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      ...
      <Stack.Screen name="Onboarding" component={OnboardingPanel} />
      <Stack.Screen name="Hub" component={HubTabs} />
      <Stack.Screen name="LocationDetails" component={LocationDetailsPanel} />
      <Stack.Screen name="AnimalDetails" component={AnimalDetailsPanel} />
      <Stack.Screen
        name="MyAnimalForm"
        component={MyAnimalFormPanel}
        options={{ animation: 'slide_from_bottom', presentation: 'modal' }}
      />
      <Stack.Screen name="QuizIntro" component={QuizIntroPanel} />
      <Stack.Screen name="QuizPlay" component={QuizPlayPanel} />
      <Stack.Screen name="QuizResults" component={QuizResultsPanel} />
      <Stack.Screen name="RanchSprintPlay" component={RanchSprintPlayPanel} />
    </Stack.Navigator>
    );
  };
...
// <Stack.Screen name="Splash" component={SplashPanel} />
  return (
    <>
    
    {!isLoading ? <SplashPanel /> : <Route isFatch={route} />}
    </>
  )
};
